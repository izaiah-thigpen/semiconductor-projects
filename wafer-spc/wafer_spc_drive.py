...
DRIVE_LINK = "https://drive.google.com/file/d/1CIjg1K06BWFVX4MBOe9LOyKgJmBndq-e/view?usp=sharing"
...
def main():
    df = pd.read_csv(fetch_csv(DRIVE_LINK))
    if "defect_label" not in df.columns:
        raise SystemExit("This file lacks a 'defect_label' column - DRIVE_LINK may point to the "
                         "IoT dataset. Put the wafer-defect CSV link in this script.\nColumns: "
                         + ", ".join(df.columns))
